...
urlpatterns = [
  ...
  path('oiamounts/<int:pk>/', OtherIngredientAmountView.as_view()), # pk=recipeID(POST) pk=amountsID(DELETE)
  ...
  path('boamounts/<int:pk>/', BaseOilAmountView.as_view()), # pk=recipeID(POST) pk=amountsID(DELETE)
]